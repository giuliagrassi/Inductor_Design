...
ft = fittype( 'k*x^a*0.025', 'independent', 'x', 'dependent', 'y' );
...
% Set up fittype and options.
ft = fittype( 'k*x^a*0.05', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( 'Method', 'NonlinearLeastSquares' );
opts.Display = 'Off';
...
% Set up fittype and options.
ft = fittype( 'k*x^a*0.1', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( 'Method', 'NonlinearLeastSquares' );
opts.Display = 'Off';
...
% Set up fittype and options.
ft = fittype( 'k*x^a*0.2', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( 'Method', 'NonlinearLeastSquares' );
opts.Display = 'Off';
...
% Set up fittype and options.
ft = fittype( 'k*x^a*0.3', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( 'Method', 'NonlinearLeastSquares' );
opts.Display = 'Off';
...
for B = 1:numel(B_range)
   for f = 1:numel(f_range)
        P(B,f) = k(B)*f_range(f)^a(B)*B_range(B);  
   end
end
%P = k*x^a*y^b
% x = frequência
...
% Set up fittype and options.
ft = fittype( 'k*x^a*y', 'independent', {'x', 'y'}, 'dependent', 'z' );
opts = fitoptions( 'Method', 'NonlinearLeastSquares' );
opts.Display = 'Off';
